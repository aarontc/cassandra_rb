...
class CassandraMockTest < CassandraTest
  ...
  def setup
    ...
    @twitter = CassandraRB::Mock.new('Twitter', @test_schema)
    @twitter.clear_keyspace!

    @blogs = CassandraRB::Mock.new('Multiblog', @test_schema)
    @blogs.clear_keyspace!

    @blogs_long = CassandraRB::Mock.new('MultiblogLong', @test_schema)
    @blogs_long.clear_keyspace!

    @type_conversions = CassandraRB::Mock.new('TypeConversions', @test_schema)
  ...
  def test_get_range_reversed_slice
    ...
    hash = CassandraRB::OrderedHash[data]
    sliced_hash = CassandraRB::OrderedHash[data.reverse[1..-1]]
