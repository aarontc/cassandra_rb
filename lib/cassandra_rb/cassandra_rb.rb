...
class CassandraRB
  ...
  def initialize(keyspace, servers = "127.0.0.1:9160", thrift_client_options = {})
    ...
    thrift_client_options[:transport_wrapper] ||= CassandraRB.DEFAULT_TRANSPORT_WRAPPER
  ...
  def keyspace=(ks)
    return false if CassandraRB.VERSION.to_f < 0.7
  ...
  #
  # This method calls CassandraRB#truncate! for each column family in the
  # keyspace.
  #
  # Please note that this only works on version 0.7.0 and higher.
  #
  ...
  ##
  # Multi-key version of CassandraRB#count_columns. Please note that this
  # queries the server for each key passed in.
  #
  # Supports same parameters as CassandraRB#count_columns.
  #
  # * column_family - The column_family that you are inserting into.
  ...
  ##
  # Multi-key version of CassandraRB#get_columns. Please note that this
  # queries the server for each key passed in.
  #
  # Supports same parameters as CassandraRB#get_columns
  #
  # * column_family - The column_family that you are inserting into.
  # * keys - An array of keys to select.
  # * columns - Either a single super_column or a list of columns.
  ...
  ##
  # Multi-key version of CassandraRB#get.
  #
  ...
  # returned.
  #
  # Supports the same parameters as CassandraRB#get.
  #
  # * column_family   - The column_family that you are inserting into.
  # * keys            - An array of keys to select.
  ...
  #
  # This method is just a convenience wrapper around CassandraRB#get_range_single
  # and CassandraRB#get_range_batch. If :key_size, :batch_size, or a block
  # is passed in CassandraRB#get_range_batch will be called. Otherwise
  # CassandraRB#get_range_single will be used.
  #
  # The start_key and finish_key parameters are only useful for iterating of all records
  # as is done in the CassandraRB#each and CassandraRB#each_key methods if you are using the
  # RandomPartitioner.
  #
  ...
  # range of keys in the column_family you request.
  #
  # See CassandraRB#get_range for more CassandraRB.
  #
  ...
  #
  # This method just calls CassandraRB#get_range_keys and returns the
  # number of records returned.
  #
  # See CassandraRB#get_range for options.
  #
  ...
  #
  # This method just calls CassandraRB#get_range and returns the
  ...
  #
  # This method just calls CassandraRB#get_range and yields each row key.
  #
  # See CassandraRB#get_range for options.
  #
  ...
  #
  # This method just calls CassandraRB#get_range and yields the key and
  # columns.
  #
  # See CassandraRB#get_range for options.
  #
